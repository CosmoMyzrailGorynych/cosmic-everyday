...
Icon ".\..\ico.ico"
outFile ".\..\..\_cosmicEverydayBuilds\CosmicEveryday_v${VERSIONMAJOR}.${VERSIONMINOR}.${VERSIONBUILD}_x64.exe"
...
section "install"
    ...
    file /r ".\..\..\_cosmicEverydayBuilds\CosmicEveryday-${VERSIONMAJOR}.${VERSIONMINOR}.${VERSIONBUILD}-win-x64\*"
